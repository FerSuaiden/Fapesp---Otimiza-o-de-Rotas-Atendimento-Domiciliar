...
try:
    ...
    # Ajusta a legenda
    ax.legend(title='Tipo de Equipe', title_fontsize='13', fontsize='12', loc='upper right')
    ...
    print("Por favor, verifique se os arquivos 'cnes_completo.csv' e 'tbEquipe.csv' estão no mesmo diretório do script.")
